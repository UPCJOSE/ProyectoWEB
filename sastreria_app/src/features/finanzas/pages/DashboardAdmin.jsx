...
export const DashboardAdmin = () => {
  ...
  const registrarEgreso = () => {
    const costo = prompt(
      "Ingrese el costo del material o servicio (solo números):",
    );
    ...
    <div className="animate__animated animate__fadeIn">
      ...
      <section className={styles.reportsBox}>
        ...
        <button
          ...
          onClick={() => alert("Generando reporte en formato Excel...")}
        >
          <i className="bi bi-file-earmark-excel"></i> Exportar a Excel
        </button>
        <button
          className="btn btn-outline-dark d-flex align-items-center gap-2"
          onClick={() => alert("Generando documento PDF...")}
        >
