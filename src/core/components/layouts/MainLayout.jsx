            ...
            <>
              ...
              <span
                className={`${styles.navLink} ${
                  location.search.includes("vista=catalogo") || location.search === "" 
                    ? styles.navLinkActive 
                    : ""
                }`}
                onClick={() => navigate("/principal?vista=catalogo")}
              >
                Catálogo
              </span>
              ...
              <span
                className={`${styles.navLink} ${
                  location.search.includes("vista=pedidos") ? styles.navLinkActive : ""
                }`}
                onClick={() => navigate("/principal?vista=pedidos")}
              >
                Mis Pedidos
              </span>
              ...
              <span
                className={`${styles.navLink} ${
                  location.search.includes("vista=perfil") ? styles.navLinkActive : ""
                }`}
                onClick={() => navigate("/principal?vista=perfil")}
              >
                Mi Perfil
              </span>

              {/* Carrito (lo mantenemos igual) */}
